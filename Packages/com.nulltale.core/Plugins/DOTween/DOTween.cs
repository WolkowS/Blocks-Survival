...
namespace DG.Tweening
{
    ...
    public class DOTween
    {
        ...
        public static IDOTweenInit Init(bool? recycleAllByDefault = null, bool? useSafeMode = null, LogBehaviour? logBehaviour = null, DOTweenSettings settings = null)
        {
            if (initialized) return instance;
            if (!Application.isPlaying || isQuitting) return null;

            settings ??= Resources.Load(DOTweenSettings.AssetName) as DOTweenSettings;
