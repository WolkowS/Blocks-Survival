	...
	public class AnimatorParamPropertyDrawer : PropertyDrawerBase
	{
		...
		public static AnimatorController GetAnimatorController(SerializedProperty property, string animatorName)
		{
			...
			if (animatorFieldInfo != null)
			{
				...
				if (animatorFieldInfo.FieldType == typeof(RuntimeAnimatorController))
			...
			if (animatorPropertyInfo != null)
			{
				...
				if (animatorPropertyInfo.PropertyType == typeof(AnimatorController))
				...
				animatorGetterMethodInfo.GetParameters().Length == 0)
			{
				...
				if (animatorGetterMethodInfo.ReturnType == typeof(AnimatorController))
