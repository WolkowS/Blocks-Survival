...
namespace Fungus
{
    ...
    public class DialogInput : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (currentStandaloneInputModule != null)
            {
                currentStandaloneInputModule.submit.action.performed += _cancelCheck;

                if (clickMode == ClickMode.ClickAnywhere)
                    currentStandaloneInputModule.leftClick.action.performed += _cancelCheck;

                if (cancelEnabled)
                    currentStandaloneInputModule.cancel.action.performed += _cancelCheck;
            }
        }
        ...
        private void _cancelCheck(InputAction.CallbackContext context)
        {
