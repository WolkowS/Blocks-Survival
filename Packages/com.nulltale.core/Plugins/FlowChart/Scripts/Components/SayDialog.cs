...
namespace Fungus
{
    ...
    /// </summary>
    [DefaultExecutionOrder(CoreLib.Core.k_ManagerDefaultExecutionOrder)]
    public class SayDialog : MonoBehaviour
    {
        ...
        public virtual RectTransform StoryTextRectTrans
        {
            get
            {
                return storyText.GetComponent<RectTransform>();
            }
        }
        ...
        public    Optional<TMP_Animation> textAnimator;
        ...
        // =======================================================================
        public class TMP_AnimationListenerAdapter : IWriterListener
        {
            public TMP_Animation _animation;
		...
		protected virtual Writer GetWriter()
        {
            ...
            if (textAnimator.Enabled)
                writer.writerListeners.Add(new TMP_AnimationListenerAdapter() { _animation = textAnimator });
        ...
        public void SetAnimationSettings(TMP_AnimationIn.Settings settings)
        {
            if (textAnimator.Enabled && textAnimator.Value.TryGetComponent<TMP_AnimationIn>(out var anim))
            {
                anim._override.Enabled = settings != null;
                anim._override.Value   = settings;
            }
        }
