    ...
    public class BlockEditor : Editor
    {
        ...
        public virtual void DrawButtonToolbar()
        {
            ...
            if (GUILayout.Button(EditorGUIUtility.IconContent("console.infoicon.sml")))
            {
                ...
                var cmd = Undo.AddComponent(block.gameObject, typeof(Say)) as Command;
                block.GetFlowchart().AddSelectedCommand(cmd);
                ...
                {
                    block.CommandList.Insert(index, cmd);
                }
                else
                {
            ...
            // Add Conversation
            if (GUILayout.Button(EditorGUIUtility.IconContent("console.erroricon.inactive.sml")))
            {
                var block     = target as Block;
                var flowchart = (Flowchart)block.GetFlowchart();
                ...
                var cmd = Undo.AddComponent(block.gameObject, typeof(Conversation)) as Command;
                block.GetFlowchart().AddSelectedCommand(cmd);
                cmd.ParentBlock = block;
                cmd.ItemId = flowchart.NextItemId();
            ...
            // Add Choose
            if (GUILayout.Button(EditorGUIUtility.IconContent("console.warnicon.inactive.sml")))
            {
                var block     = target as Block;
                var flowchart = (Flowchart)block.GetFlowchart();
                ...
                var cmd = Undo.AddComponent(block.gameObject, typeof(Menu)) as Command;
                block.GetFlowchart().AddSelectedCommand(cmd);
                cmd.ParentBlock = block;
                cmd.ItemId = flowchart.NextItemId();
