...
namespace Fungus.EditorUtils
{
    ...
    public class FlowchartEditor : Editor 
    {
        ...
        public override void OnInspectorGUI() 
        {
            ...
            {
                var fwnd = (FlowchartWindow)EditorWindow.GetWindow(typeof(FlowchartWindow), false, "Flowchart");
                if (fwnd.blocks.Length > 0)
                    fwnd.SelectBlock(fwnd.blocks.FirstOrDefault());
            }
