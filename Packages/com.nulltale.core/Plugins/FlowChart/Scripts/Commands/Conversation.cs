...
namespace Fungus
{
    ...
    [AddComponentMenu("")]
    [ExecuteInEditMode]
    public class Conversation : Command, ILocalizable
    {
        ...
        [SerializeField]
        protected FloatData waitForSeconds = new FloatData(0);

        [SerializeField]
        protected BooleanData fadeWhenDone = new BooleanData(true);

        public Optional<Vers<TMP_AnimationIn.Settings>> _animation;
        ...
        protected virtual IEnumerator DoConversation()
        {
            ...
            conversationManager.Animation = _animation.GetValueOrDefault()?.Value;
        ...
        {
            return conversationText.stringVal;
        }

        public void SetStandardText(string standardText)
        {
            conversationText.stringVal = standardText;
        }
