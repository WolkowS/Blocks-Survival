...
namespace Fungus
{
    ...
    public class Menu : Command, ILocalizable, IBlockCaller
    {
        ...
        [Tooltip("Called if choose selected")]
        [SerializeField] protected UnityEvent onChoose;
        ...
        public override void OnEnter()
        {
            ...
            if (menuDialog != null)
            {
                ...
                menuDialog.AddOption(displayText, interactable, hideOption, targetBlock, onChoose.Invoke);
            }
