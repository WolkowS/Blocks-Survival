...
namespace CoreLib.Midi
{
    ...
    [CustomPropertyDrawer(typeof(MidiOutput.MidiNoteFilter), true)]
    sealed class MidiNoteFilterDrawer : PropertyDrawer
    {
        ...
        static readonly GUIContent [] _octaveLabels = {
            new GUIContent("All"),
            new GUIContent("-1"), new GUIContent("0"), new GUIContent( "1"),
            new GUIContent( "2"), new GUIContent("3"), new GUIContent( "4"),
            new GUIContent( "5"), new GUIContent("6"), new GUIContent( "7"),
