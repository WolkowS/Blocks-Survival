...
namespace CoreLib.Serializer
{
    ...
    public abstract class SerializableScriptableObject : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        public virtual void OnBeforeSerialize()
        {
            ...
            var indexOf = m_ResourcePath.IndexOf(Serialization.k_ResourcesPrefix, StringComparison.Ordinal);
            m_ResourcePath = indexOf >= 0 ? 
                Path.ChangeExtension(m_ResourcePath.Substring(indexOf + Serialization.k_ResourcesPrefix.Length), null) :
                "";
#endif
        }
